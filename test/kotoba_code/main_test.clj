...
(deftest read-cli-args-validates-before-host-call
  (is (= {:error "usage: clojure -M -m kotoba-code.main --read <project-root> <path> [start] [end]"}
         (#'main/read-cli-args nil "src/a.clj" nil nil nil)))
  (is (= {:error "usage: clojure -M -m kotoba-code.main --read <project-root> <path> [start] [end]"}
         (#'main/read-cli-args "root" nil nil nil nil)))
  (is (= {:error "too many arguments for --read; usage: clojure -M -m kotoba-code.main --read <project-root> <path> [start] [end]"}
